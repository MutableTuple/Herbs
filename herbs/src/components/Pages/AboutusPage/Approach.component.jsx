...
const Approach = () => {
  return (
    <section className="pt-5 mt-md-2 mt-xl-4 mt-xxl-5">
          ...
          <SwiperSlide>
            <div className="card border-0 bg-secondary rounded-5 h-100">
              <div className="card-body">
                ...
                <h3 className="h4">Individual approach</h3>
                <p className="mb-0">
                  Find aute irure dolor in reprehenderit in voluptate velit esse
                  cillum dolore eu fugiat nulla pariatur neque congue aliqua
                  dolor.
                </p>
              </div>
            </div>
            ...
            <div className="card border-0 bg-secondary rounded-5 h-100">
              <div className="card-body">
                ...
                <p className="mb-0">
                  ...
                  Phasellus eget molestie massa. Donec egestas nulla pariatur.
                </p>
              </div>
            </div>
          </SwiperSlide>
          ...
          <SwiperSlide>
            <div className="card border-0 bg-secondary rounded-5 h-100">
              <div className="card-body">
                ...
                <h3 className="h4">Step by step work</h3>
                <p className="mb-0">
                  More erat leo proin odio est sed sit felis facilisi integer
                  sed congue neque turpis dictumst sit sed volutpat aliquet
                  tortor.
                </p>
              </div>
            </div>
      ...
      {/* <div className="swiper-pagination position-relative bottom-0 mt-2 pt-4 d-lg-none swiper-pagination-clickable swiper-pagination-bullets swiper-pagination-horizontal">
        <span
