...
import LoadJarallax from "./LoadJarallax.component";
    ...
    <>
      ...
      >
        <div className="rounded-5 overflow-hidden">
          <div
            className="jarallax ratio ratio-16x9"
            data-jarallax=""
            data-speed="0.6"
          >
            <div
            ...
            >
              <div
                ...
                style={{
                  backgroundImage:
                    'url("./src/assets/img/about/agency/parallax-image.jpg")',
                  transformStyle: "preserve-3d",
                }}
                data-jarallax-original-styles="background-image: url(./src/assets/img/about/agency/parallax-image.jpg);"
              ></div>
            </div>
          </div>
        </div>
