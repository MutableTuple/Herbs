    ...
    <div className="row row-cols-1 row-cols-md-2 g-4 mb-4">
      ...
      <section className="col">
        <div className="card h-100 border-0 py-1 p-md-2 p-xl-3 p-xxl-4">
          <div className="card-body">
            <div className="d-flex align-items-center mt-sm-n1 pb-4 mb-1 mb-lg-2">
              <i className="ai-wallet text-primary lead pe-1 me-2"></i>
            ...
            <div className="alert alert-danger d-flex mb-0">
              ...
              <p className="mb-0">
                Your primary credit card expired on 01/04/2023. Please add a new
                card or update this one.
              </p>
            </div>
          </div>
        </div>
...
export default AddressBillingSection;
